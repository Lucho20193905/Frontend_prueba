    ...
    makeBody={
      () => <div>
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col">
              <h5 style={{color:"black"}}>1.- Tarjeta De Video Asus Tuf Gaming Oc gtx1650 4gb Gddr6</h5>
              <div class="progress">
            ...
            <div class="col">
              <h5 style={{color:"black"}}>2.- Core i7-11900k</h5>
              <div class="progress">
        ...
        <div class="row">
          <div class="col">
            <h5 style={{color:"black"}}>3.- Gabinete Pc Gamer Cooler Master H500 Argb Templado Midtower</h5>
            <div class="progress">
          ...
          <div class="col">
            <h5 style={{color:"black"}}>4.- Ssd Sata A400 480gb</h5>
            <div class="progress">
        ...
        <div class="row">
          <div class="col">
            <h5 style={{color:"black"}}>5.- Memoria Ram 8gb 2600mhz Laptop Kingston</h5>
            <div class="progress">
          ...
          <div class="col">
            <h5 style={{color:"black"}}>Intel (59%) vs AMD (41%)</h5>
            <div class="progress">
